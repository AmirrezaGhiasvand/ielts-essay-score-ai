...
export const UI_TEXT = {
  en: {
    ...
    latency: "Scored in",
    chatPlaceholder: "Ask a question about your score or how to improve...",
    chatSend: "Send",
    chatTitle: "Ask the Examiner",
    newEssay: "Score Another Essay",
    errorShort: "Essay too short",
    errorGeneral: "Something went wrong. Please try again.",
    errorWrongKey: "Wrong api key, please enter a correct one.",
    errorConnection: "No internet connection was established.",
    apiKey: "API Key",
    titleApiKey: "OpenRouter API Key",
    submitApiKey: "Save API Key",
  ...
  fa: {
    ...
    latency: "نمره‌دهی در",
    chatPlaceholder: "سوالی درباره نمره خود یا راه‌های بهتر شدن بپرسید...",
    chatSend: "ارسال",
    ...
    errorWrongKey: "کلید API وارد شده مشکل دارد، لطفا آن را تغییر دهید.",
    errorConnection: "دسترسی به اینترنت برقرار نشد.",
    apiKey: "کلید API",
    titleApiKey: "کلید API سایت Openrouter",
    submitApiKey: "API ذخیره کلید",
    language: "زبان پاسخ",
    clear: "پاکسازی",
    paste: "جایگذاری",
